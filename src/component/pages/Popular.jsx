    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500">Popular articles are selected based on the number of readers</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:grid-rows-2 lg:grid-cols-3 lg:grid-rows-2">
        ...
        <div className="md:col-span-2 lg:col-span-2 h-64 bg-gray-200
 ...
 ">
          <div className="p-4">
            <p className="text-white text-end align-text-bottom text-lg font-semibold">
              The basis of making the correct system design and according to needs.
            </p>
...
"></div>
 ...
 ">
          <div className="p-4">
            <p className="text-white font-semibold">Refreshing the legacy dayforce employee profile</p>
          </div>
        </div>
 ...
 ">
      ...
      <div className=' md:col-span-2'>
            <img src="https://images.pexels.com/photos/531767/pexels-photo-531767.jpeg" alt="" className='h-96 w-full' />
        </div>
